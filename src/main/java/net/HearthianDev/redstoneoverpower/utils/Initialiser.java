...
public class Initialiser {
  ...
  public static final Identifier NOTE_BLOCK_SOUND_ID = Identifier.of("redstoneoverpower:sculk_note_block_sound");
  ...
  public static void initBlockItems() {
    ...
    // Screen handlers
    Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MOD_ID, "duct"), DUCT_SCREEN_HANDLER);
