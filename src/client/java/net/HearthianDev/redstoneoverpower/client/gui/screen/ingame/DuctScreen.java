...
public class DuctScreen extends HandledScreen<DuctScreenHandler> {
  private static final Identifier FILTER_SLOT_TEXTURE = Identifier.of("container/crafter/disabled_slot");
  ...
  private static final Identifier TEXTURE = Identifier.of("redstoneoverpower", "textures/gui/container/duct.png");
